...
def readini(filePath, key):
    ...
    # env表示section，根据key在对应的section中去value
...
if __name__ == '__main__':
    ...
    # print(content)
    # content = readyaml(r"ZongHe/data_case/register_pass.yaml")
    # print(content)
    # content = readyaml(r"ZongHe/data_case/repeat_data.yaml")
    # print(content)
    content = readyaml(r"ZongHe/data_case/login_fail.yaml")
    print(content)
