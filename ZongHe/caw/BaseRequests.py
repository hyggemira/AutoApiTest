...
if __name__ == '__main__':
    ...
    # print(r.text)
    # r = BaseRequests().get("http://jy001:8081/futureloan/mvc/api/member/login?mobilephone=13112345678&pwd=123456")
    # print(r.text)
    r = BaseRequests().post("http://jy001:8081/futureloan/mvc/api/member/login", data={"mobilephone": "13112345678", "pwd": "123456"})
    print(r.text)
